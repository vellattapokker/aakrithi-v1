<?php $__env->startSection('title', 'My Account | Aakrithi'); ?>
...
<div class="dashboard-wrapper">
    ...
    <div class="dashboard-header-premium">
        <div class="header-main">
            <h1>My Account</h1>
            <p>Welcome back, <?php echo e(explode(' ', Auth::user()->name)[0]); ?> — curated style awaits.</p>
        </div>
        ...
        <aside class="dashboard-sidebar">
            <div class="sidebar-user-card">
                ...
                <div class="sidebar-stats-premium">
                    ...
                    <div class="stat-mini">
                        <span class="stat-value-mini"><?php echo e($addressCount); ?></span>
...
<?php /* User requested removal of member status */ ?>
        ...
        <div class="dashboard-content-area">
            <section class="content-card-premium">
                ...
                <div class="hub-grid">
                    <div class="hub-box" onclick="window.location='<?php echo e(route('account.orders')); ?>'">
                        <i data-lucide="package"></i>
                        <h4>Wardrobe Timeline</h4>
                        <span><?php echo e($orderCount); ?> Orders Processed</span>
                    </div>
                    <div class="hub-box" onclick="window.location='<?php echo e(route('account.addresses')); ?>'">
                        <i data-lucide="map-pin"></i>
                        <h4>Managed Locales</h4>
                        <span><?php echo e($addressCount); ?> Saved Points</span>
                    </div>
                </div>

<?php /* Removed Member Perks as requested: it doesnt have memberships */ ?>
            </section>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder\Git uploads\aakrithi-v1\resources\views/account-dashboard.blade.php ENDPATH**/ ?>