<?php $__env->startSection('title', 'Saved Addresses | Aakrithi'); ?>
...
<div class="dashboard-wrapper">
    ...
    <div class="dashboard-header-premium">
        ...
        <div class="header-actions">
            <a href="<?php echo e(route('account.dashboard')); ?>" class="logout-btn-premium"><i data-lucide="arrow-left"></i> Back to Hub</a>
        </div>
    </div>
    ...
    <div class="dashboard-main-grid">
        ...
        <aside class="dashboard-sidebar">
            <div class="sidebar-user-card">
                ...
                <div class="sidebar-stats-premium">
                    <div class="stat-mini">
                        <span class="stat-value-mini"><?php echo e($orderCount); ?></span>
                        <span class="stat-label-mini">Orders</span>
                    </div>
                    <div class="stat-divider"></div>
                    <div class="stat-mini">
                        <span class="stat-value-mini"><?php echo e($addresses->count()); ?></span>
            ...
            <nav class="sidebar-nav-premium">
                ...
                <a href="<?php echo e(route('account.orders')); ?>"><i data-lucide="shopping-bag"></i> Order History</a>
                <a href="<?php echo e(route('account.addresses')); ?>" class="<?php echo e(request()->routeIs('account.addresses') ? 'active' : ''); ?>"><i data-lucide="map-pin"></i> Saved Addresses</a>
        ...
        <nav class="mobile-nav-premium">
            ...
            <a href="<?php echo e(route('account.orders')); ?>"><i data-lucide="shopping-bag"></i></a>
            <a href="<?php echo e(route('account.addresses')); ?>" class="<?php echo e(request()->routeIs('account.addresses') ? 'active' : ''); ?>"><i data-lucide="map-pin"></i></a>
            ...
            <section id="addresses-section" class="content-card-premium">
                ...
                <div class="address-grid-premium">
                    <?php $__empty_1 = true; $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="address-premium-card <?php echo e($address->is_default ? 'is-default' : ''); ?>">
                            <?php if($address->is_default): ?>
                                <div class="default-ribbon">Primary</div>
                            <?php endif; ?>
                            <div class="address-card-header">
                                <h3><?php echo e($address->name); ?></h3>
                                <div class="address-icons">
                                    <i data-lucide="home"></i>
                                </div>
                            </div>
                            <div class="address-body">
                                <p class="phone"><i data-lucide="phone" style="width:14px; height:14px;"></i> <?php echo e($address->phone); ?></p>
                                <p class="location"><?php echo e($address->address); ?></p>
                                <p class="city-state"><?php echo e($address->city); ?>, <?php echo e($address->state); ?> — <?php echo e($address->pincode); ?></p>
                            </div>
                            <div class="address-footer-premium">
                                <?php if(!$address->is_default): ?>
                                <form method="POST" action="<?php echo e(route('address.default', $address->id)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn-text-gold">Set Primary</button>
                                </form>
                                <?php endif; ?>
                                <form method="POST" action="<?php echo e(route('address.destroy', $address->id)); ?>" class="ms-auto">
                                    <?php echo csrf_field(); ?>
                ...
                <div id="new-address-form" class="new-address-form-wrapper">
                    ...
                    <form method="POST" action="<?php echo e(route('address.store')); ?>" class="premium-form-grid">
                        <?php echo csrf_field(); ?>
                        <div class="form-row">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\aakriti-laravel\resources\views/account-addresses.blade.php ENDPATH**/ ?>