<?php $__env->startSection('title', 'Order History | Aakrithi'); ?>
...
<div class="dashboard-wrapper">
    ...
    <div class="dashboard-header-premium">
        ...
        <div class="header-actions">
            <a href="<?php echo e(route('account.dashboard')); ?>" class="logout-btn-premium"><i data-lucide="arrow-left"></i> Back to Dashboard</a>
        </div>
    </div>
        ...
        <aside class="dashboard-sidebar">
            <div class="sidebar-user-card">
                ...
                <div class="sidebar-stats-premium">
                    <div class="stat-mini">
                        <span class="stat-value-mini"><?php echo e($orders->total()); ?></span>
                        <span class="stat-label-mini">Orders</span>
                    </div>
                    <div class="stat-divider"></div>
                    <div class="stat-mini">
                        <span class="stat-value-mini"><?php echo e(Auth::user()->addresses()->count()); ?></span>
                        <span class="stat-label-mini">Locales</span>
                    </div>
                </div>

                <div class="member-since">Joined <?php echo e(Auth::user()->created_at->format('M Y')); ?></div>
            </div>

            <nav class="sidebar-nav-premium">
                <a href="<?php echo e(route('account.dashboard')); ?>" class="<?php echo e(request()->routeIs('account.dashboard') ? 'active' : ''); ?>"><i data-lucide="user"></i> Profile Hub</a>
                <a href="<?php echo e(route('account.orders')); ?>" class="<?php echo e(request()->routeIs('account.orders') ? 'active' : ''); ?>"><i data-lucide="shopping-bag"></i> Order History</a>
                <a href="<?php echo e(route('account.addresses')); ?>"><i data-lucide="map-pin"></i> Saved Addresses</a>
                <a href="<?php echo e(route('account.profile')); ?>" class="<?php echo e(request()->routeIs('account.profile') ? 'active' : ''); ?>"><i data-lucide="settings"></i> Account Settings</a>
            </nav>
        </aside>

        
        <nav class="mobile-nav-premium">
            <a href="<?php echo e(route('account.dashboard')); ?>" class="<?php echo e(request()->routeIs('account.dashboard') ? 'active' : ''); ?>"><i data-lucide="user"></i></a>
            <a href="<?php echo e(route('account.orders')); ?>" class="<?php echo e(request()->routeIs('account.orders') ? 'active' : ''); ?>"><i data-lucide="shopping-bag"></i></a>
            <a href="<?php echo e(route('account.addresses')); ?>"><i data-lucide="map-pin"></i></a>
            <a href="<?php echo e(route('account.profile')); ?>" class="<?php echo e(request()->routeIs('account.profile') ? 'active' : ''); ?>"><i data-lucide="settings"></i></a>
        </nav>
        ...
        <div class="dashboard-content-area">
            <section class="content-card-premium">
                <div class="card-header-premium">
                    ...
                    <span class="badge-count"><?php echo e($orders->total()); ?> Total</span>
                </div>
                ...
                <?php if($orders->isEmpty()): ?>
                    <div class="empty-state-premium">
                        ...
                        <a href="<?php echo e(route('shop')); ?>" class="btn-premium-gold">Explore Collection</a>
                    </div>
                <?php else: ?>
                            ...
                            <div class="order-item-premium">
                                <div class="order-main-info">
                                    ...
                                    <div class="order-date">
                                        <i data-lucide="calendar"></i> <?php echo e($order->created_at->format('M d, Y')); ?>

                                    </div>
                                </div>
                                <div class="order-status-price">
                                    <div class="status-badge status-<?php echo e(strtolower($order->status)); ?>"><?php echo e(ucfirst($order->status)); ?></div>
                                    <div class="price">₹<?php echo e(number_format($order->total)); ?></div>
                                </div>
                                <div class="order-action">
                                    <a href="<?php echo e(route('order.show', $order->order_number)); ?>" class="btn-view-order">Details <i data-lucide="chevron-right"></i></a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder\Git uploads\aakrithi-v1\resources\views/account-orders.blade.php ENDPATH**/ ?>