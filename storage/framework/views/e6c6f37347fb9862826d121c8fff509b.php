<?php $__env->startSection('meta_title', 'Wholesale Checkout | Aakrithi B2B'); ?>
        ...
        <div class="order-summary-section">
            <div class="checkout-card summary-card glass-card reveal-blur">
                ...
                <div class="moq-badge-mini">
                    <i data-lucide="check-circle"></i> MOQ Met (<?php echo e($totalQuantity); ?> Pcs)
                </div>
                ...
                <div class="summary-items">
                    ...
                    <div class="summary-item">
                        <div class="item-info">
                            ...
                            <span class="item-meta">Bulk Qty: <?php echo e($details['quantity']); ?></span>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\New folder\Git uploads\aakrithi-v1\resources\views/wholesale-checkout.blade.php ENDPATH**/ ?>